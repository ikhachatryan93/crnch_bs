...
cb_search_results_urls = "https://www.crunchbase.com/app/search/companies/249a41b33de7bc8b2d2a3edcdd266278bae9c7dd"
...
class CrunchBaseCompanyInfo:
    COMPANY_URL_CSS_CLASS = "cb-link.layout-align-start-center.layout-row.flex"
    ...
    def get_all_images(self):
        try:
            ...
            see_more = self.wait_5.until(
                EC.visibility_of_element_located((By.CSS_SELECTOR, ".square-gallery__see-more")))
